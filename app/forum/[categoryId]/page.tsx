        ...
        <div className="flex justify-end mb-4">
          {userId ? (
            <Link
              ...
              className="flex items-center gap-2 px-4 py-2 bg-primary text-primary-foreground rounded font-[family-name:var(--font-pixel)] text-sm hover:bg-primary/90 transition-colors"
            >
            ...
            <Link
              href="/sign-in"
              className="flex items-center gap-2 px-4 py-2 bg-secondary text-muted-foreground rounded font-[family-name:var(--font-pixel)] text-sm hover:bg-secondary/80 transition-colors"
            >
              <PenLine className="w-4 h-4" />
              Sign in to post
            </Link>
